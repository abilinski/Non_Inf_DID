set more off
capture log close
capture log using sippl08puw4.log, replace
set mem 777m

**------------------------------------------------;

**  This program reads the 2008 SIPP Wave 4 Core Data File 
**  Note:  This program is distributed under the GNU GPL. See end of
**  this file and http://www.gnu.org/licenses/ for details.
**  by Jean Roth Tue Dec 21 11:35:13 EST 2010
**  Please report errors to jroth@nber.org
**  run with do sippl08puw4
...
local dat_name "${indir}\l08puw4.dat"

** The following line should contain the path to your output '.dta' file 

local dta_name "${indir}\sippl08puw4.dta"

** The following line should contain the path to the data dictionary file 

local dct_name "${inprog}\sippl08puw4.dct"


quietly infile using "`dct_name'", using("`dat_name'") clear

** The following line should contain the complete path and name of the compressed data file. ;

/*local compressed "/homes/data/sipp/2008/l08puw4.zip"

** Removing dat_name
capture rm `dat_name'

** Uncompressing the raw data file to /tmp
** Note that /tmp must have enough space to write the uncompressed file
! unzip -p `compressed' > "`dat_name'"

** The line below does NOT need to be changed 

quietly infile using "`dct_name'", using("`dat_name'") clear

** Removing the temp file when finished
! rm -f "`dat_name'"
