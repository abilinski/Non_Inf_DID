...
**  by Jean Roth Wed Nov  3 16:01:51 EDT 2010
**  Please report errors to jroth@nber.org
**  run with do sippl08puw2
...
*include "F:\YoungAdults\AEJEPcode\programs\readin\sipp_dir.doh";



local dat_name "${indir}\l08puw2.dat"

** The following line should contain the path to your output '.dta' file 

local dta_name "${indir}\sippl08puw2.dta"

** The following line should contain the path to the data dictionary file 

local dct_name "${inprog}\sippl08puw2.dct"
