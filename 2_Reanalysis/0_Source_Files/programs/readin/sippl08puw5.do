...
set more off
capture log close
log using sippl08puw5, text replace
set mem 777m

**------------------------------------------------;

**  This program reads the 2008 SIPP Wave 5 Core Data File 
**  Note:  This program is distributed under the GNU GPL. See end of
**  this file and http://www.gnu.org/licenses/ for details.
**  by Jean Roth Mon Aug  1 17:45:39 EDT 2011
**  Please report errors to jroth@nber.org
**  run with do sippl08puw5
...
local dat_name "${indir}\l08puw5.dat"

** The following line should contain the path to your output '.dta' file 

local dta_name "${indir}\sippl08puw5.dta"

** The following line should contain the path to the data dictionary file 

local dct_name "${inprog}\sippl08puw5.dct"
