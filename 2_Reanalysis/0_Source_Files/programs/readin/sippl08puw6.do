...
set more off
capture log close
log using sippl08puw6, text replace
set mem 777m

**------------------------------------------------;

**  This program reads the 2008 SIPP Wave 6 Core Data File 
**  Note:  This program is distributed under the GNU GPL. See end of
**  this file and http://www.gnu.org/licenses/ for details.
**  by Jean Roth Thu Jun  2 11:14:28 EDT 2011
**  Please report errors to jroth@nber.org
**  run with do sippl08puw6
...
local dat_name "${indir}\l08puw6.dat"

** The following line should contain the path to your output '.dta' file 

local dta_name "${indir}\sippl08puw6.dta"

** The following line should contain the path to the data dictionary file 

local dct_name "${inprog}\sippl08puw6.dct"
