set more off
capture log close
log using sippl08puw9.log, replace
set mem 777m

**------------------------------------------------;

**  This program reads the 2008 SIPP Wave 9 Core Data File 
**  Note:  This program is distributed under the GNU GPL. See end of
**  this file and http://www.gnu.org/licenses/ for details.
**  by Jean Roth Thu Mar 29 22:44:38 EDT 2012
**  Please report errors to jroth@nber.org
**  run with do sippl08puw9
...
local dat_name "${indir}\l08puw9.dat"

** The following line should contain the path to your output '.dta' file 

local dta_name "${indir}\sippl08puw9.dta"

** The following line should contain the path to the data dictionary file 

local dct_name "${inprog}\sippl08puw9.dct"
