clear
capture log close
log using sippl08puw8, text replace
set mem 777m

**------------------------------------------------;

**  This program reads the 2008 SIPP Wave 8 Core Data File 
**  Note:  This program is distributed under the GNU GPL. See end of
**  this file and http://www.gnu.org/licenses/ for details.
**  by Jean Roth Thu Dec  1 13:58:08 EST 2011
**  Please report errors to jroth@nber.org
**  run with do sippl08puw8
...
local dat_name "${indir}\l08puw8.dat"

** The following line should contain the path to your output '.dta' file 

local dta_name "${indir}\sippl08puw8.dta"

** The following line should contain the path to the data dictionary file 

local dct_name "${inprog}\sippl08puw8.dct"
