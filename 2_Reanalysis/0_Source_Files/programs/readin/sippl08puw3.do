clear
capture log close
log using sippl08puw3, text replace
set mem 1000m

**------------------------------------------------;

**  This program reads the 2008 SIPP Wave 3 Core Data File 
**  Note:  This program is distributed under the GNU GPL. See end of
**  this file and http://www.gnu.org/licenses/ for details.
**  by Jean Roth Wed Nov  3 16:01:57 EDT 2010
**  Please report errors to jroth@nber.org
**  run with do sippl08puw3
...
local dat_name "${indir}\l08puw3.dat"

** The following line should contain the path to your output '.dta' file 

local dta_name "${indir}\sippl08puw3.dta"

** The following line should contain the path to the data dictionary file 

local dct_name "${inprog}\sippl08puw3.dct"
