clear
capture log close
log using sippl08puw10.log, replace
set mem 777m
**------------------------------------------------;

**  This program reads the 2008 SIPP Wave 10 Core Data File 
**  Note:  This program is distributed under the GNU GPL. See end of
**  this file and http://www.gnu.org/licenses/ for details.
**  by Jean Roth Thu Jun  7 11:57:14 EDT 2012
**  Please report errors to jroth@nber.org
**  run with do sippl08puw10
...
local dat_name "${indir}\l08puw10.dat"

** The following line should contain the path to your output '.dta' file 

local dta_name "${indir}\sippl08puw10.dta"

** The following line should contain the path to the data dictionary file 

local dct_name "${inprog}\sippl08puw10.dct"
